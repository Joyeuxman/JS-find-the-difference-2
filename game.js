...
define("jquery.fullscreen", ["jquery"], function(){});

define('FullScreen',['jquery.fullscreen'],function(fullScreen){
    // 全屏按扭
    // box 全屏按扭放置的位置，即父元素
...
define('StartScene',['Scene','FullScreen'],function(Scene,FullScreen){
    // 开始场景
...
define('TimeoutScene',['Scene'],function(Scene){
    // 超时场景
...
define('GameScene',['Scene','Differences','FullScreen','SecondManager','Label','TimeoutScene'],function(Scene,Differences,FullScreen,SecondManager,Label,TimeoutScene){
    // 找不同场景
    // 找不同游戏数据
...
define('CompleteScene',['Scene'],function(Scene){
    // 通关场景
...
define('GameSceneDatas',[],function(){
    GameSceneDatas = [
        {
            src: 'images/1.jpg',
            seconds: 45, 
...
define('Game',['require','exports','module','jquery','Audio','StartScene','GameScene','CompleteScene','GameSceneDatas'],function(require,exports,module){
    // 不写依赖项列表时用下边的写法
    // 下边的引入写法不推荐
    var $ = require('jquery'),
        Audio = require('Audio'),
    ...
    // 整体游戏控制
    module.exports = Game = function(box){
        this.box = box
        // 创建音效对象，播放背景音乐
